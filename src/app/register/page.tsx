            ...
            <div className="max-w-md mx-auto px-6">
                ...
                <div className="bg-white p-8 border border-gray-100">
                    <p className="text-sm text-ink-muted mb-6 text-center">
                        JoinJournal | GEEX - Electronics Guides| GEEX for exclusive offers, order tracking, and faster checkout.
                    </p>
                    ...
                    {success && (
                        <div className="mb-6 p-4 bg-green-50 border border-green-200 text-green-600 text-sm text-center">
                            鉁?Account created successfully! Redirecting...
                        </div>
                    )}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full bg-orbit-blue text-white py-4 uppercase tracking-widest text-xs font-bold hover:bg-blue-hover transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                    ...
                    <div className="mt-6 text-center text-xs text-ink-muted">
                        ...
                        <Link href="/terms" className="underline hover:text-orbit-blue">
                            Terms of Service
                        </Link>{" "}
                        and{" "}
                        <Link href="/privacy" className="underline hover:text-orbit-blue">
                            Privacy Policy
                        </Link>
                        .
                    </div>
