export default function JournalLoading() {
    return (
        <div className="bg-cool-white min-h-screen pt-[72px] lg:pt-[88px] animate-pulse">
            {/* Hero Skeleton */}
            ...
            {/* Filter Bar Skeleton */}
            <div className="sticky top-[72px] lg:top-[88px] z-30 bg-cool-white/95 border-b border-gray-200 py-4">
