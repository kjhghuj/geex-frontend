...
export function ProfileContent({ user }: { user: any }) {
  ...
  return (
    <div className="bg-white p-8 border border-gray-100">
      <h2 className="font-serif text-2xl text-near-black mb-6">Profile Details</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="md:col-span-2">
          ...
          <input
            type="email"
            value={user?.email || ""}
            className="w-full border border-gray-200 px-4 py-3 focus:outline-none focus:border-near-black bg-gray-50"
            disabled
          />
      ...
      <button
        ...
        className="mt-6 bg-near-black text-white px-8 py-3 uppercase tracking-widest text-xs font-bold hover:bg-near-black/90 transition-colors disabled:opacity-50 flex items-center gap-2"
      >
      ...
      {process.env.NODE_ENV === "development" && (
        <div className="mt-8 pt-8 border-t border-gray-100">
          <h3 className="text-sm font-semibold text-near-black mb-4">[DEV] Test Tools</h3>
          <button
            onClick={async () => {
              try {
            ...
            className="bg-gray-200 text-near-black px-4 py-2 text-xs font-bold uppercase tracking-widest hover:bg-gray-300"
          >
