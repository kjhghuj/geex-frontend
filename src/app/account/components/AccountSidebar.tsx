          ...
          return (
            <button
              ...
              className={`
                ...
                ${isActive
                  ? "text-orbit-blue bg-orbit-blue/5 md:bg-orbit-blue/10 font-medium"
                  : "text-ink-muted hover:text-near-black hover:bg-gray-50 bg-transparent"
                }
              `}
            >
              <Icon
                className={`mb-1 md:mb-0 md:mr-3 transition-transform group-hover:scale-105 ${isActive ? "text-orbit-blue" : "text-ink-muted group-hover:text-near-black"
                  }`}
                size={20}
