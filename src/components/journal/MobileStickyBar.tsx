        ...
        >
            <div className="flex items-center justify-between gap-4">
                <div className="flex flex-col">
                    <span className="font-serif text-near-black text-sm truncate max-w-[180px]">
                        Enjoying this article?
                    </span>
                    <span className="text-[10px] text-orbit-blue font-bold uppercase tracking-widest">
                        Explore the collection
                    </span>
                </div>
                <Link
                    href="/shop"
                    className="bg-near-black text-white px-6 py-3 text-xs uppercase font-bold tracking-widest rounded-sm shadow-lg whitespace-nowrap"
                >
                    Shop Now
                </Link>
            </div>
