            ...
            {totalPages > 1 && (
                <div className="flex justify-center items-center gap-4 mt-24">
                    <button
                        ...
                        className="p-2 rounded-full border border-gray-200 text-gray-500 hover:border-orbit-blue hover:text-orbit-blue disabled:opacity-30 disabled:hover:border-gray-200 disabled:hover:text-gray-500 transition-colors"
                    >
                        <ChevronLeft size={20} />
                    </button>
